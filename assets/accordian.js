...
$(document).ready(function() {
  $('div.demo-show h1').add('div.demo-show2 h1').hover(function() {
    $(this).addClass('hover');
  }, function() {
...
$(document).ready(function() {
  ...
  $('div.demo-show:eq(0) > h1').click(function() {
...
$(document).ready(function() {
  ...
  $('div.demo-show:eq(1) > h1').click(function() {
...
$(document).ready(function() {
  ...
  $('div.demo-show2:eq(0) > h1').click(function() {
...
$(document).ready(function() {
  ...
  $('div.demo-show2:eq(1) > h1').click(function() {
